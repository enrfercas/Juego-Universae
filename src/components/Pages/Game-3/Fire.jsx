          ...
          <div className="row">
            <div className="col-12">
              <h1 className="titulo-juego">
                PROTOCOLO SOBRE EXTINCIÓN DE INCENDIOS
              </h1>
            </div>
          </div>
          <div className="row">
            ...
            <div className="col-lg-3 d-flex justify-content-center">
              <div className="galeria-juego">
                ...
                <img
                  ...
                  onClick={() =>
                    handleImageClick(
                      "public/Games-Images/InterfazGame/Miniaturas/Extincion/Extincion0.png"
                    )
                  }
                ...
                <img
                  ...
                  onClick={() =>
                    handleImageClick(
                      "public/Games-Images/InterfazGame/Miniaturas/Extincion/Extincion1.png"
                    )
                  }
                ...
                <img
                  ...
                  onClick={() =>
                    handleImageClick(
                      "public/Games-Images/InterfazGame/Miniaturas/Extincion/Extincion2.png"
                    )
                  }
                ...
                <img
                  ...
                  onClick={() =>
                    handleImageClick(
                      "public/Games-Images/InterfazGame/Miniaturas/Extincion/Extincion3.png"
                    )
                  }
                ...
                <img
                  ...
                  onClick={() =>
                    handleImageClick(
                      "public/Games-Images/InterfazGame/Miniaturas/Extincion/Extincion4.png"
                    )
                  }
